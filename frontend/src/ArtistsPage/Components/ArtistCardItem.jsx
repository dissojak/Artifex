...
import Unfollow from "../../assets/images/unfollowIcon.svg";

// import { useGetUserMutation } from "../../slices/usersApiSlice";

const ArtistCardItem = (props) => {
  const rating = Math.round(props.rating);
  const star1 = `${props.id}star1`;
  const star2 = `${props.id}star2`;
  const star3 = `${props.id}star3`;
      ...
      <div className="cardArtist9">
          ...
          <div className="info9">
            ...
            <div className="stats9">
              <div className="flex flex-col">
                Artworks
                <span className="state-value9"> {props.numberOfArtworks} </span>
              </div>
              <div className="flex">
                Followers
                <span className="state-value9">
                  {" "}
        ...
        <div className="follow_social9">
          <button className="bookmarkBtn9">
            <span
              className={
                !props.isFollowing ? "IconContainer9" : "IconContainer9_hovered"
              }
            >
            ...
            {!props.isFollowing ? <p className="text9">follow</p> : null}
          </button>

      ...
      <div className="cardArtist9">
          ...
          <div className="info9">
            ...
            <div className="cont-rating9">
              <div className="rating9">
                ...
                <input value="2" name="rating" id="star2" type="radio" defaultChecked/>
        ...
        <div className="follow_social9">
          ...
          <div className="card_social9">
            ...
            <a className="socialContainer9 containerTwo9" href="#">
              <svg
                viewBox="0 0 16 16"
            ...
            <a className="socialContainer9 containerThree9" href="#">
              <svg
                viewBox="0 0 448 512"
            ...
            <a className="socialContainer9 containerFour9" href="#">
              <svg
                viewBox="0 0 16 16"

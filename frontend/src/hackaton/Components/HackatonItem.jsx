...
const HackatonItem = (props) => {

  const auth = useContext(AuthContext);

  const [isRegistered, setIsRegistered] = useState(props.participants.includes(auth.teamId));
  const[numberParticipants,setNumberParticipants] = useState(props.participantsCount);
        ...
        <div id="hackaton_info">
          ...
          <div id="mail_flag">
            ...
            <div id="flame_flag">
              ...
              <em id="flags_nb">{numberParticipants}</em>
              {!isRegistered && (
              <button className="btnSave" onClick={registerInHackatonHandeler}>
                <svg
                  aria-label="Register"

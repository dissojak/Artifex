...
const SavedArwork = () => {
 ...
 {Artworks.map(Artwork => (
        <div  className="savedartwork-card">
          <img src={Artwork.Image} alt="" className="savedartwork-card-image" />
          <div className="savedartwork-card-body">
            <div className="savedartwork-card-footer">

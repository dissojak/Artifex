...
const ArtsSection = () => {
  ...
  <p class="text">Add to Cart</p>
    ...
    <img src={heart} style={{width:'15px',height:'15px'}} alt='heart' />
        ...
        <div  className="cardd">
          <img src={Art1} alt="" className="card-image" />
          <div className="card-body">
            <h5 className="card-title">The Moon</h5>
            <p className="card-text">12.99 DT</p>
  ...
  <p class="text">Add to Cart</p>
    ...
    <img src={heart} style={{width:'15px',height:'15px'}} alt='heart' />
        ...
        <div  className="cardd">
          <img src={Art2} alt="" className="card-image" />
          <div className="card-body">
            <h5 className="card-title">The Moon</h5>
            <p className="card-text">12.99 DT</p>
  ...
  <p class="text">Add to Cart</p>
    ...
    <img src={heart} style={{width:'15px',height:'15px'}} alt='heart' />
        ...
        <div  className="cardd">
          <img src={Art3} alt="" className="card-image" />
          <div className="card-body">
            <h5 className="card-title">The Moon</h5>
            <p className="card-text">12.99 DT</p>
  ...
  <p class="text">Add to Cart</p>
    ...
    <img src={heart} style={{width:'15px',height:'15px'}} alt='heart' />
        ...
        <div  className="cardd">
          <img src={Art4} alt="" className="card-image" />
          <div className="card-body">
            <h5 className="card-title">The Moon</h5>
            <p className="card-text">12.99 DT</p>
  ...
  <p class="text">Add to Cart</p>
    ...
    <img src={heart} style={{width:'15px',height:'15px'}} alt='heart' />
        ...
        <div  className="cardd">
          <img src={Art5} alt="" className="card-image" />
          <div className="card-body">
            <h5 className="card-title">The Moon</h5>
            <p className="card-text">12.99 DT</p>
  ...
  <p class="text">Add to Cart</p>
    ...
    <img src={heart} style={{width:'15px',height:'15px'}} alt='heart' />
        ...
        <div  className="cardd">
          <img src={Art6} alt="" className="card-image" />
          <div className="card-body">
            <h5 className="card-title">The Moon</h5>
            <p className="card-text">12.99 DT</p>

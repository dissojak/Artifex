...
const TeamBehind = () => {
  ...
  <div className="card2-socials">
    <a href='https://www.facebook.com/dissojak' target="_blank" className="card2-socials-btn facebook">
      <svg
    ...
    <a href="https://github.com/dissojak" target="_blank" className="card2-socials-btn github" role="button">
  <svg xmlns="http://www.w3.org/2000/svg" width="33" height="33" viewBox="0 0 24 24">
    ...
    <a href='https://www.linkedin.com/in/adembenamor/' target="_blank" className="card2-socials-btn linkedin">
      <svg
...
<div className="card2">
  ...
  <div className="card2-socials">
    <a href='https://www.facebook.com/tarek.chebbi.71/' target="_blank" className="card2-socials-btn facebook">
      <svg>
    ...
    <a href='https://github.com/TarekChebbi' target="_blank" className="card2-socials-btn github">
      <svg
        xmlns="http://www.w3.org/2000/svg"
        width="33"
        height="33"
    ...
    <a href='https://www.linkedin.com/in/tarek-chebbi/' target="_blank" className="card2-socials-btn linkedin">
      <svg
        xmlns="http://www.w3.org/2000/svg"
        width="512"
        viewBox="0 0 512 512"

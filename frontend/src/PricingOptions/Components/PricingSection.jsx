  ...
  return (
    <>
      <div id="PricingSection-section">
        ...
        <p className="PricingSection-details7" style={{ fontSize: '12px', color: '#5bd6ff',fontFamily:'Raleway-Bold' }}>
        Discover
          </p>
      ...
      <div className="planContent">
        ...
        <div className="planPrice">
          <img src={Option.Image} alt="Options" className="OptionsIcons"  style={Option.Type === 'Diamond' ? { width: '55px', height: '55px' } : {}} />
          <span style={{fontFamily:'Dubai-Bold'}}>{Option.Price}DT</span>
        </div>
